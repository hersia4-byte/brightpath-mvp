#!/usr/bin/env node
// Entry point for the TikTok Ads MCP server.
//
...
//
// HTTP options via env: PORT (default 3001), MCP_PATH (default /mcp),
...
if (process.argv.includes("--check")) {
  console.log(JSON.stringify({ tiktok: ready ? "configured" : `NOT configured — ${missingHint}` }, null, 2));
  process.exit(0);
}
