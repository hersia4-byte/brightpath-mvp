...
const NAV_ITEMS = [
  ...
  { to: '/haya-house', label: 'Haya House',   icon: 'youtube' },
]
    ...
    <BrowserRouter>
      <Layout dark={dark} setDark={setDark} user={user} onSignOut={() => setUser(null)}>
        <Routes>
          ...
          <Route path="/haya-house" element={<YouTubeVideo dark={dark} />} />
        </Routes>
      </Layout>
    </BrowserRouter>
  )
